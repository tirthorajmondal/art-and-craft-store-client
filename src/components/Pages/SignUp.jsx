...
const SignUp = () => {
    ...
    return (
        <div className="h-[calc(100vh-150px)] flex justify-center items-center">
            ...
            <div className="flex flex-col p-6 border-2  justify-center items-center w-fit rounded-lg">
                <form
                    ...
                    <label className="input input-bordered flex items-center gap-2">
                        ...
                        <input type="text" className="grow" name="password" defaultValue={123456} placeholder="password" />
                    </label>
